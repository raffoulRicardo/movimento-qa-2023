...
public class PreenchimentoDeCadaCampo extends Metodos {
    ...
    @Test
    public void nomePreenchidoPesquisadoEApagado () {
    ...
    @Test
    public void apenasCpfPreenchido () {
    ...
    @Test
    public void apenasCelularPreenchido () {
    ...
    @Test
    public void apenasDataNascimentoPreenchido () {
